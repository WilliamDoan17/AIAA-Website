...
const UpdateMemberModal = ({ projectId, member, onClose }: UpdateMemberModalProps) => {
      ...
      <div className="bg-panel border border-rim rounded-2xl w-full max-w-sm mx-4 p-6 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className={`bg-surface border rounded-xl px-4 py-2.5 text-sm font-body text-copy focus:outline-none transition-colors duration-200 ${titleError ? 'border-red-400' : 'border-rim focus:border-accent'}`}
          />
