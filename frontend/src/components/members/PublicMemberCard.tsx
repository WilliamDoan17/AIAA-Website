...
const PublicMemberCard = ({ member }: Props) => (
  <Link to={`/members/${member.id}`} className="bg-panel border border-rim p-10 px-8 relative overflow-hidden text-center transition-[background,border-color] duration-300 hover:bg-surface hover:border-accent block no-underline">
