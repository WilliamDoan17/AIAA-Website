...
const LandingProjectCard = ({ project }: Props) => (
  <Link to={`/projects/${project.id}`} className="bg-panel border border-rim flex flex-col overflow-hidden relative transition-[border-color,transform] duration-300 hover:border-accent hover:-translate-y-1 group no-underline">
